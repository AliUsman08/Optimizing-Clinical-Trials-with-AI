...
For more information here's an article I wrote on how you can also implement AI in clinical trial applications: bit.ly/optimizing-clinical-trials-with-AI.

For more detailed steps on documentation check out https://pytrial.readthedocs.io/en/latest/.
